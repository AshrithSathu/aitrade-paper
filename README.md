...
- Each trade uses the configured percentage of current NAV, capped by maximum dollars and contracts. The backend calculates fractional contracts and requires the actual purchased side to retain positive fee-adjusted edge.
